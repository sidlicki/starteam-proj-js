import{f as b,b as L}from"./coctail@2x-804d4a57.js";const r=document.querySelector(".modal-cocktail-content"),p=document.querySelector(".modal-btn-close"),v=document.querySelector(".overlay"),u=document.querySelector(".modal1");let i=JSON.parse(localStorage.getItem("favoriteCocktails"))||[];function h(a){return a.map(e=>`<li class="add-li"><a href="" class="add-two" id="${e.ingredientId}">${e.title}</a>
