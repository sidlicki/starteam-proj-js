import{f as k,b as L}from"./coctail-1bddb463.js";const r=document.querySelector(".modal-cocktail-content"),h=document.querySelector(".modal-btn-close"),v=document.querySelector(".overlay"),u=document.querySelector(".modal1");let d=JSON.parse(localStorage.getItem("favoriteCocktails"))||[];function p(o){return o.map(e=>`<li class="add-li"><a href="" class="add-two" id="${e.ingredientId}">${e.title}</a>
