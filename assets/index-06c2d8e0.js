import{P as j,a as g,s as y,c as w,o as A,d as E,b as N,e as H,g as I,n as L,h as k}from"./add-remove-favorite-c50e2dd9.js";import{n as O,a as W}from"./coctail@2x-d8dacd4c.js";function P(e,o){let t=9,r=3;const s=document.getElementById("tui-pagination-container");new j(s,{totalItems:e.length,itemsPerPage:t,visiblePages:r}).getCurrentPage();const l=()=>{let n=[],a=t,c=0;for(let i=0;i<Math.ceil(e.length/t);i++){for(n.push([]),c;c<a&&e[c]!==void 0;c++)n[i].push(e[c]);a+=t}return n};console.log(l());const u=n=>{console.log(n),console.log(l()[n]),console.log("");const a=l()[n].map(c=>{const{_id:i,drink:b,drinkThumb:T,description:q}=c;return`
