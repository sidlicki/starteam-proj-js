import{P as A,a as m,s as k,c as E,o as H,d as I,b as N,e as O,g as P,n as y,h as v}from"./add-remove-favorite-5f2ec23d.js";import{n as W,a as B}from"./coctail@2x-d8dacd4c.js";function $(){const e=window.innerWidth;return Number(e>1280?"9":"8")}function p(e,n){let t=$(),a=3;const s=document.getElementById("tui-pagination-container");new A(s,{totalItems:e.length,itemsPerPage:t,visiblePages:a}).getCurrentPage();const u=()=>{let o=[],r=t,c=0;for(let i=0;i<Math.ceil(e.length/t);i++){for(o.push([]),c;c<r&&e[c]!==void 0;c++)o[i].push(e[c]);r+=t}return o};console.log(u());const l=o=>{console.log(o),console.log(u()[o]),console.log("");const r=u()[o].map(c=>{const{_id:i,drink:L,drinkThumb:j,description:w}=c;return`
