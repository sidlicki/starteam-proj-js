import{P as j,a as g,s as y,d as w,e as A,n as L,g as k}from"./coctail-e7ab091e.js";import{o as E,c as N,b as H,f as I,n as O,a as W}from"./coctail@2x-3a14991e.js";function P(e,o){let t=9,r=3;const s=document.getElementById("tui-pagination-container");new j(s,{totalItems:e.length,itemsPerPage:t,visiblePages:r}).getCurrentPage();const l=()=>{let n=[],a=t,c=0;for(let i=0;i<Math.ceil(e.length/t);i++){for(n.push([]),c;c<a&&e[c]!==void 0;c++)n[i].push(e[c]);a+=t}return n};console.log(l());const u=n=>{console.log(n),console.log(l()[n]),console.log("");const a=l()[n].map(c=>{const{_id:i,drink:b,drinkThumb:T,description:q}=c;return`
